 ...
 * <h3>Support only a specific origin</h3> To support a single origin instead of the wildcard use the following:
 * 
 * <pre>
 * CorsConfig corsConfig = CorsConfig.withOrigin("http://domain1.com")
 * </pre>
 *
 * <h3>Enable loading from the file system</h3> To enable the server to handle an origin specified as 'null', which happens when a web browser loads a file from the local file
