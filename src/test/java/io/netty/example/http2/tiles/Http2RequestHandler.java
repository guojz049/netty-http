...
/**
 * Handles all the requests for data. It receives a {@link FullHttpRequest}, which has been converted by a {@link InboundHttp2ToHttpAdapter} before it arrived here. For further
 * details, check {@link Http2OrHttpHandler} where the pipeline is setup.
 */
