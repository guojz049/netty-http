...
/**
 * Negotiates with the browser if HTTP2 or HTTP is going to be used. Once decided, the Netty pipeline is setup with the correct handlers for the selected protocol.
 */
